  ...
  const pronunciationLessons = [
    {
      id: 1,
      title: 'Âm /θ/ và /ð/',
      description: 'Luyện tập phát âm âm th trong tiếng Anh',
      difficulty: 'Cơ bản',
      words: 15,
      completed: true,
      accuracy: 85,
    },
    {
      id: 2,
      title: 'Âm /r/ và /l/',
      description: 'Phân biệt và phát âm đúng âm r và l',
      difficulty: 'Cơ bản',
      words: 20,
      completed: false,
      accuracy: 0,
    },
    {
      id: 3,
      title: 'Âm /v/ và /w/',
      description: 'Luyện tập phát âm chính xác âm v và w',
    ...
    },
    {
      id: 4,
      title: 'Trọng âm từ',
      description: 'Học cách đặt trọng âm đúng trong các từ nhiều âm tiết',
      difficulty: 'Nâng cao',
      words: 25,
      completed: false,
      accuracy: 0,
    ...
    <div style={{ padding: '20px 0' }}>
        ...
        <Row gutter={[24, 24]} align="middle">
          ...
          <Col xs={24} md={16}>
            <Row gutter={[16, 16]}>
              <Col xs={12} sm={6}>
                <div style={{ textAlign: 'center' }}>
                  <Title level={2} style={{ color: '#fa541c', margin: 0 }}>78</Title>
                  <Paragraph style={{ margin: 0, color: '#666' }}>Từ đã luyện</Paragraph>
                </div>
              </Col>
              <Col xs={12} sm={6}>
                <div style={{ textAlign: 'center' }}>
                  <Title level={2} style={{ color: '#52c41a', margin: 0 }}>85%</Title>
                  <Paragraph style={{ margin: 0, color: '#666' }}>Độ chính xác</Paragraph>
                </div>
              </Col>
              <Col xs={12} sm={6}>
                <div style={{ textAlign: 'center' }}>
                  <Title level={2} style={{ color: '#1890ff', margin: 0 }}>12</Title>
                  <Paragraph style={{ margin: 0, color: '#666' }}>Ngày streak</Paragraph>
                </div>
              </Col>
              <Col xs={12} sm={6}>
                <div style={{ textAlign: 'center' }}>
                  <Title level={2} style={{ color: '#722ed1', margin: 0 }}>4</Title>
                  <Paragraph style={{ margin: 0, color: '#666' }}>Cấp độ</Paragraph>
                </div>
              </Col>
            </Row>
          </Col>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '40px' }}>
        {pronunciationLessons.map((lesson) => (
          <Col xs={24} sm={12} lg={6} key={lesson.id}>
            <Card
              hoverable
              style={{ 
                height: '100%',
                borderRadius: '12px',
                border: '1px solid rgba(250, 84, 28, 0.1)',
              }}
              cover={
                <div style={{ 
                  padding: '30px', 
            ...
            >
              <Card.Meta
                title={
                  <div>
                    <div style={{ color: '#fa541c', marginBottom: '4px' }}>
                      {lesson.title}
                    </div>
                    <div style={{ 
                      fontSize: '12px', 
                      ...
                      {lesson.difficulty} • {lesson.words} từ
                    </div>
                  </div>
                }
                description={
                  <div>
                    ...
                    {lesson.completed ? (
                      <div style={{ color: '#52c41a', fontSize: '12px' }}>
                        <CheckCircleOutlined /> Hoàn thành - {lesson.accuracy}% chính xác
                      </div>
                    ) : (
              ...
              <div style={{ 
                ...
                <Paragraph 
                  style={{ 
                    ...
                    fontWeight: achievement.earned ? '600' : 'normal',
                  }}
                >
                  {achievement.name}
                </Paragraph>
